...
// Defined directly here so it cannot be "missing"
const SpaceMenuInternal = () => {
  // Hardcoded data to guarantee it loads
  const items = [
...
const AdDisplay = () => {
  ...
  // FORCE LOAD THE SPACE MENU
  return <SpaceMenuInternal />;
};
