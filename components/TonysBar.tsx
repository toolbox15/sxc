...
// --- MAIN COMPONENT RENAMED BACK TO TonysBar ---
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden bg-cover bg-center font-sans" style={{ backgroundImage: "url('/field-bg.png')" }}>
      ...
      <div className="relative z-20 w-full h-full grid grid-cols-12 gap-6 p-12">
        ...
        {/* Kickoff: Bumped Category +1px to 31px, Titles to 21px */}
        ...
        {/* Main Event: Bumped Category +1px to 31px, Titles to 25px */}
        ...
        {/* Draft Picks: Bumped Category +1px to 31px, Titles to 21px */}
