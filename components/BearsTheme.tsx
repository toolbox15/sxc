...
// --- 🚨 SIREN IMAGE COMPONENT (Uses siren.png) ---
const SirenImage = () => {
  return (
    <div className="relative z-50 w-40 h-40 flex items-center justify-center">
      ...
      {/* The Flashing Bulb Effect (Overlay on top of image) */}
      <motion.div 
         className="absolute inset-0 bg-red-500 mix-blend-hard-light rounded-t-full z-30"
         style={{ clipPath: "inset(10% 20% 30% 20%)" }} 
         animate={{ opacity: [0, 0.8, 0] }} 
         transition={{ duration: 0.6, repeat: Infinity, ease: "easeInOut" }}
      />

      {/* The External Glow (Bloom behind image) */}
      <motion.div 
         className="absolute top-1/4 left-1/4 w-1/2 h-1/2 bg-red-600 blur-3xl rounded-full z-10"
  ...
  return (
    <div className="absolute inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden bg-black/80 backdrop-blur-md">
      ...
      >
        ...
        {/* Left Siren */}
        <div className="absolute -top-20 -left-16 z-50">
            <SirenImage />
        </div>
        {/* Right Siren */}
